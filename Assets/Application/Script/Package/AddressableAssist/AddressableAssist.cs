...
namespace Project.Lib {
	...
	public partial class AddressableAssist {
		...
		/// アセットをロード
		/// </summary>
		public async static void LoadAssetAsync(string address, System.Action<object> callback) {
			var obj = await AssetControl.LoadAssetAsync(address);
			callback(obj);
		}
		...
		/// アセットをロード
		/// </summary>
		public async static void LoadAssetsAsync(List<string> addresses, System.Action<List<Object>> callback) {
			var obj = await AssetControl.LoadAssetsAsync(addresses);
			callback(obj);
		}
