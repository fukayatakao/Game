...
/// <summary>
/// SettingData structure for specifying settings of Stable Diffusion server API or
...
/// <summary>
/// SettingData structure to easily serialize the parameters to send
/// to the Stable Diffusion server when generating an image via Txt2Img.
/// </summary>
class SDParamsInTxt2Img2222 : Project.Network.Request{
...
/// <summary>
/// SettingData structure to easily deserialize the data returned
...
/// <summary>
/// SettingData structure to easily deserialize the JSON response returned
/// by the Stable Diffusion server after generating an image via Txt2Img.
///
...
/// <summary>
/// SettingData structure to help serialize into a JSON the model to be used by Stable Diffusion.
...
/// <summary>
/// SettingData structure to help deserialize from a JSON the state of the progress of an image generation.
/// </summary>
...
/// <summary>
/// SettingData structure to help deserialize from a JSON the progress status of an image generation.
/// </summary>
class SDProgress {
