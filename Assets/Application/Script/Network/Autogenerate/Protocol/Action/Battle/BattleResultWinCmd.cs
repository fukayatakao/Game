...
namespace Project.Network
{
	...
	public static class BattleResultWinCmd
	{
		...
		/// 非同期通信実行
		/// </summary>
		public async static Task<Command.Result> CreateTask(BattleResultWinRequest request) {
		...
		/// 非同期通信実行
		/// </summary>
		public async static void CreateAsync(BattleResultWinRequest request, System.Action<Response> success = null, System.Action<Response, System.Net.WebExceptionStatus> failure = null) {
		...
		/// Json解析
		/// </summary>
		private static Response Parse( string __text ) { return JsonUtility.FromJson<BattleResultWinResponse>(__text); }
	...
	/// リクエストデータクラス
	/// </summary>
	public class BattleResultWinRequest : Request
	{
		public BattleResultWinRequest(int invaderId, int defenderId, int nodeId){
	...
	/// レスポンスデータクラス
	/// </summary>
	public class BattleResultWinResponse : Response
	{
		//---- レスポンス変数定義 ----
